    ...
    renderGallery(){
    	return(
    	    <Measure whitelist={['width']}>
    	    {
              ...
              console.log('w:- ',width);
        		    var cols = 4;
                console.log('width:- ', width, 'this.state.photos:- ',this.state.photos[0].width);
        		    if (width >= 480){
        			       cols = 2;
        		    }
        		    if (width >= 1024){
        		    ...
        		    return <Gallery photos={this.state.photos} cols={cols} onClickPhoto={this.openLightbox} onMouseOver={this.resizeImage} />
        		}
    	    }
    	    </Measure>
    	);
